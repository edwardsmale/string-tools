...
/* harmony import */ var _command_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./command.service */ "./src/app/command.service.ts");
/* harmony import */ var _text_utils_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./text-utils.service */ "./src/app/text-utils.service.ts");
...
const _c1 = ["inputPane"];
class AppComponent {
    constructor(commandService, textUtilsService) {
    ...
    UpdateExplanation(codeValue, inputValue) {
    ...
    ProcessClick(codeValue, inputValue) {
...
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_command_service__WEBPACK_IMPORTED_MODULE_1__["CommandService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"])); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 17, vars: 2, consts: [[1, "string-tools"], [1, "string-tools__top_section"], [1, "code-window", 3, "input"], ["codePane", ""], ["readonly", "", 1, "explain-window"], [1, "panes-container"], [1, "pane", "pane--left"], [1, "pane-textarea", 3, "input"], ["inputPane", ""], [1, "pane", "pane--right"], ["outputPane", ""], ["readonly", "", 1, "pane-textarea"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function AppComponent_Template_textarea_input_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4); const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](11); ctx.UpdateExplanation(_r0.value, _r1.value); return ctx.ProcessClick(_r0.value, _r1.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function AppComponent_Template_textarea_input_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4); const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](11); return ctx.ProcessClick(_r0.value, _r1.value); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _command_service__WEBPACK_IMPORTED_MODULE_1__["CommandService"] }, { type: _text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"] }]; }, { codePaneRef: [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommandParsingService", function() { return CommandParsingService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _text_utils_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./text-utils.service */ "./src/app/text-utils.service.ts");
/* harmony import */ var _command_types_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./command-types.service */ "./src/app/command-types.service.ts");




class CommandParsingService {
    constructor(textUtilsService, commandTypesService) {
        this.textUtilsService = textUtilsService;
...
CommandParsingService.ɵfac = function CommandParsingService_Factory(t) { return new (t || CommandParsingService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_text_utils_service__WEBPACK_IMPORTED_MODULE_1__["TextUtilsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_command_types_service__WEBPACK_IMPORTED_MODULE_2__["CommandTypesService"])); };
CommandParsingService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CommandParsingService, factory: CommandParsingService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CommandParsingService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _text_utils_service__WEBPACK_IMPORTED_MODULE_1__["TextUtilsService"] }, { type: _command_types_service__WEBPACK_IMPORTED_MODULE_2__["CommandTypesService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommandTypesService", function() { return CommandTypesService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class CommandTypesService {
    constructor(textUtilsService) {
        this.textUtilsService = textUtilsService;
        ...
        this.CommandTypes = [
                    ...
                    if (!searchString && context.regex) {
                        if (explain) {
                            ...
                            if (Object(util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value)) {
                                return value.filter(function (val) { return new RegExp(context.regex).test(val); });
                            }
                            else {
                        ...
                        if (explain) {
                            ...
                            if (Object(util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value)) {
                                return value.filter(function (val) { return val.includes(searchString); });
                            }
                            else {
                ...
                exec: (function (value, para, context, explain) {
                    ...
                    if (!regex && context.searchString) {
                        if (explain) {
                            ...
                            if (Object(util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value)) {
                                return value.filter(function (val) { return !val.includes(context.searchString); });
                            }
                            else {
                        ...
                        if (explain) {
                            ...
                            if (Object(util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value)) {
                                return value.filter(function (val) { return !new RegExp(regex).test(val); });
                            }
                            else {
            ...
            },
            {
                ...
                para: [
                    ...
                    {
                        name: "@",
                        desc: "When values are enclosed in double quotes, precede " +
                            "opening double quotes with the @ symbol."
                    },
                    {
                        name: "\\",
                        desc: "When values are enclosed in double quotes, escape " +
                ...
                exec: (function (value, para, context, explain) {
                    ...
                    if (explain) {
                        ...
                        var toDelimitedString = function (value, options) {
                            var result = [];
                            var i;
            ...
            },
            {
                ...
                exec: (function (value, para, context, explain) {
                    if (explain) {
                        ...
                        var result = para;
                        var i;
                        var arrayValue = Object(util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value) ? value : ["", value];
...
CommandTypesService.ɵfac = function CommandTypesService_Factory(t) { return new (t || CommandTypesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"])); };
CommandTypesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CommandTypesService, factory: CommandTypesService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CommandTypesService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"] }]; }, null); })();
...
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(util__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _text_utils_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./text-utils.service */ "./src/app/text-utils.service.ts");
/* harmony import */ var _command_parsing_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./command-parsing.service */ "./src/app/command-parsing.service.ts");
/* harmony import */ var _command_types_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./command-types.service */ "./src/app/command-types.service.ts");
...
class CommandService {
    constructor(textUtilsService, commandParsingService, commandTypesService) {
        this.textUtilsService = textUtilsService;
    ...
    processCommands(codeValue, inputValue, explain) {
        ...
        for (i = 0; i < codeLines.length; i++) {
            ...
            if (parsedCommand.commandType.name === "flat|batch") {
                ...
                for (j = 0; j < currentValues.length; j++) {
                    const newLineValue = parsedCommand.commandType.exec(currentValues[j], parsedCommand.para, context, explain);
...
CommandService.ɵfac = function CommandService_Factory(t) { return new (t || CommandService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_command_parsing_service__WEBPACK_IMPORTED_MODULE_3__["CommandParsingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_command_types_service__WEBPACK_IMPORTED_MODULE_4__["CommandTypesService"])); };
CommandService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CommandService, factory: CommandService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CommandService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _text_utils_service__WEBPACK_IMPORTED_MODULE_2__["TextUtilsService"] }, { type: _command_parsing_service__WEBPACK_IMPORTED_MODULE_3__["CommandParsingService"] }, { type: _command_types_service__WEBPACK_IMPORTED_MODULE_4__["CommandTypesService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextUtilsService", function() { return TextUtilsService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! util */ "./node_modules/util/util.js");
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(util__WEBPACK_IMPORTED_MODULE_1__);
...
class TextUtilsService {
    constructor() {
        ...
        this.FormatDelimiter = function (delimiter, pluralise) {
            var formatDelimiterSingular = function (delimiter) {
                if (delimiter === "\t") {
                    return "tab";
                }
                else if (delimiter === " ") {
...
TextUtilsService.ɵfac = function TextUtilsService_Factory(t) { return new (t || TextUtilsService)(); };
TextUtilsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: TextUtilsService, factory: TextUtilsService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TextUtilsService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
module.exports = __webpack_require__(/*! c:\Users\edwar\Dev\string-tools\string-tools\src\main.ts */"./src/main.ts");
